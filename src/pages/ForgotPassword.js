                            ...
                            <form className="w-full text-center p-5 flex-auto justify-center">
                                ...
                                {processing ?
                                    <div className="flex items-center justify-center">
                                        <button type="button" className="inline-flex items-center justify-center mt-4 px2 py-2 w-4/5 bg-gray-500 border border-white text-base shadow-md font-medium tracking-wider text-white rounded-lg hover:shadow-lg hover:bg-gray-600 cursor-not-allowed" disabled="">
                                    ...
                                    :
                                    <button type='submit' onClick={(e) => SendOtp(e)} className="mt-4 px2 py-2 w-4/5 bg-gray-600 border border-white text-base shadow-md font-medium tracking-wider text-white rounded-lg hover:shadow-lg hover:bg-gray-700">Verify Email</button>
                                }
