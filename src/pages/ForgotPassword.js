                        ...
                        <div className="w-full max-w-lg p-5 relative mx-auto my-auto rounded-2xl shadow-2xl bg-white ">
                            ...
                            <form className="text-center p-5 flex-auto justify-center">
                                ...
                                {processing ?
                                    ...
                                    :
                                    <button type='submit' onClick={(e) => SendOtp(e)} className="mt-4 px2 py-2 w-4/5 bg-gray-600 border border-white text-sm sm:text-base shadow-md font-medium tracking-wider text-white rounded-lg hover:shadow-lg hover:bg-gray-700">Verify Email</button>
                                }
                                <Link to="/login" className="inline-flex px-8 py-2 text-sm sm:text-base text-indigo-400">Back To Login</Link>
