                        ...
                        <div className="mt-8 p-4">
                            ...
                            <div className="flex p-2 mt-4 mb-10">
                                <div className="flex-auto flex justify-center">
                                    <button onClick={this.confirmationHandler} className="text-base mx-4 hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer hover:bg-teal-700 bg-teal-600 text-teal-100 border duration-200 ease-in-out border-teal-600 transition">Edit</button>
                                    <button onClick={this.cancleHandler} className="text-base mx-4 hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold cursor-pointer hover:bg-teal-200 bg-teal-100 text-teal-700 border duration-200 ease-in-out border-teal-600 transition">Cancle</button>
                                </div>
                            </div>
                        </div>
                    </div>
