...
class Test extends Component {
    ...
    submitHandler = (e) =>{
        ...
        try{
            ...
            console.log("final req source : "+ this.state.fields.email)
        // axios.defaults.headers.post['Content-Type'] ='application/x-www-form-urlencoded';
        axios.post(API_URL+"login", this.state.fields, config)
        .then(response => {
            error_message = 0;
    ...
    handleValidation(){
        ...
        if(!fields["password"]){
           formIsValid = false;
           errors["password"] = "Passwrod Cannot be empty";
        }
                    ...
                    <div className="mt-12">
                        ...
                        <div className="py-2 text-red-600 ">
                            ...
                            <div>
                                ...
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"  ref="email"size="30" type="email" name="email" value={email} onChange={this.changeHandler} placeholder="mike@gmail.com"/>
                                :
                                <>
                                <input className="w-full text-lg py-2 border-b border-red-500 focus:outline-none focus:border-indigo-500"  ref="email"size="30" type="email" name="email" value={email} onChange={this.changeHandler} placeholder="mike@gmail.com"/>
                            ...
                            <div className="mt-8">
                                ...
                                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" ref="password" size="30" type="password" name="password" value={password} onChange={this.changeHandler} placeholder="Enter your password"/>
                               : 
                                <> <input className="w-full text-lg py-2 border-b border-red-500 focus:outline-none focus:border-indigo-500" ref="password" size="30" type="password" name="password" value={password} onChange={this.changeHandler} placeholder="Enter your password"/>
