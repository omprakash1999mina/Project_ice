            ...
            <p>
                <ul className="list-outside m-6 list-decimal">
                    <li className="m-4">
                        ...
                        (2) cancellation due to reasons not attributable to Royal_IITian's, that is, in the event you provide incorrect particulars, contact number, delivery address etc., or that you were unresponsive, not reachable or unavailable for fulfillment of the services offered to you, shall amount to breach of your unconditional and irrevocable authorization in favour of Royal_IITian's to place that Order against the Restaurant Partners/Store(s) on your behalf ( <h2 className="font-bold inline"> “Authorization Breach" </h2> ). In the event you commit an Authorization Breach, you shall be liable to pay the liquidated damages of an amount equivalent to the Order Value. You hereby authorize Royal_IITian's to deduct or collect the amount payable as liquidated damages through such means as Royal_IITian's may determine in its discretion, including without limitation, by deducting such amount from any payment made towards your next Order
                    </li>
                    <li className="m-4">
                        There may be cases where Royal_IITian's is either unable to accept your order or cancels the order, due to reasons including without limitation, technical errors, unavailability of the item(s) ordered, or any other reason attributable to Royal_IITian's, Restaurant Partner/Store or Delivery Partner. In such cases, Royal_IITian's shall not charge a cancellation charge from you. If the order is cancelled after payment has been charged and you are eligible for a refund of the Order Value or any part thereof, the said amount will be reversed to you.
                    </li>
                    <li className="m-4">
