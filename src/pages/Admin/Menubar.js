                        ...
                        <ul className="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                            ...
                            <li className="mr-3 felx-1">
                                <NavLink to={{pathname: '/admin/analytics',
                                    ...
                                    <i activeClassName="fas fa-chart-area pr-0 md:pr-3 text-blue-600" className="fas fa-chart-area pr-0 md:pr-3"></i><span className="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">Analytics</span>
                                </NavLink>
                            </li>
                            <li className="mr-3 felx-1">
                                <NavLink to={{pathname: '/admin/orders',
                                            state: {id: "adminOrders"}}} activeClassName="border-green-600" className="block py-1 md:py-3 pl-1 align-middle text-white no-underline border-b-2 border-gray-800 hover:border-green-600">
